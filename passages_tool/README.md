...
- **Style packs (optional)** — `meta.style` plus `styles/<id>.json` and `presets/<name>/diffuse.png` composite wall bands in **meters**. Interval PNGs remain overrides. See `writer_docs/passages_style_preparation_20SEP26.md`.
